define(["exports", "./boot.js", "../mixins/property-effects.js", "../mixins/mutable-data.js", "./settings.js"], function (_exports, _boot, _propertyEffects, _mutableData, _settings) {
  "use strict";
  ...
  */
  ...
  function (_base) {
    ...
    function TemplateInstanceBase(props) {
      ...
      _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(TemplateInstanceBase).call(this));
      ...
      for (var n = _this.root.firstChild; n; n = n.nextSibling) {
        children.push(n);
        n.__templatizeInstance = babelHelpers.assertThisInitialized(babelHelpers.assertThisInitialized(_this));
      }
