define(["exports", "../utils/boot.js", "../utils/settings.js", "../utils/mixin.js", "../utils/style-gather.js", "../utils/resolve-url.js", "../elements/dom-module.js", "./property-effects.js", "./properties-mixin.js"], function (_exports, _boot, _settings, _mixin, _styleGather, _resolveUrl2, _domModule, _propertyEffects, _propertiesMixin) {
  "use strict";
  ...
  _exports.updateStyles = _exports.registrations = _exports.instanceCount = _exports.ElementMixin = _exports.version = void 0;
  ...
  var ElementMixin = (0, _mixin.dedupingMixin)(function (base) {
    ...
    function getTemplateFromDomModule(is) {
      ...
      if (is && (!_settings.strictTemplatePolicy || _settings.allowTemplateFromDomModule)) {
        template = _domModule.DomModule.import(is, 'template'); // Under strictTemplatePolicy, require any element with an `is`
